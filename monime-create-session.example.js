...
async function demoCreateSession() {
    ...
    const body = {
        ...
        successUrl: "https://example.com/payment-success.html?source=checkout&course=Example&price=NLe%201000",
        cancelUrl: "https://example.com/payment-cancelled.html?source=checkout&course=Example&price=NLe%201000",
        lineItems: [
            {
                type: "custom",
